...
# I like to do the maindownload, if any, in the first code chunk. Then, I don't
# need to re-run this code every time I fix something. We discussed col_types()
# in class. Again, without this, the code still runs, but would produce an
# annoying message. That message won't get outputted here because include=FALSE
# prevents it.
